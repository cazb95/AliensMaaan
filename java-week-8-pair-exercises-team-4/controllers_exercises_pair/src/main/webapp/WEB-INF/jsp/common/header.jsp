...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="/ssg-exercises-pair/ssgForumOutput#">Alien Forum</a></li>  
             <li><a href="/ssg-exercises-pair/ssgForumInput#">Join the Convo!</a></li> 
             <li><a href="/ssg-exercises-pair/viewCart#">Shopping Cart</a></li> 
        </ul>
    </nav>